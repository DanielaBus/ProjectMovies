                    ...
                    <div key={index} className="col-md-4 mb-4">
                        <div className="card h-100">
                            ...
                            <div className="card-body text-center">
                                ...
                                <p className="card-text"><strong>Creador:</strong> {item.creator}</p>
                                <p className="card-text"><strong>Rating:</strong> {item.rating}</p>
                                <p className="card-text"><strong>Fechas:</strong> {item.dates}</p>
                                <p className="card-text"><strong>Canal:</strong> {item.channel}</p>
                                <Button
                                    variant="danger"
